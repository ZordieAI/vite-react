            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6">
                <div className="mx-auto grid gap-3 sm:gap-2 sm:grid-cols-5">
                    <Card className="bg-primary/10 group overflow-hidden shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-bold">Track Every Step Effortlessly</p>
                                <p className="text-muted-foreground mt-3 max-w-sm text-sm">Quick AI is always just a click away, ready to help you stay organized and productive—no distractions, just results.</p>
                            </div>
                        </CardHeader>
                    ...
                    <Card className="bg-primary/10 group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl">
                        <p className="mx-auto my-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:p-6">Crystal Clear Recordings, Instantly Accessible</p>
                    ...
                    <Card className="bg-primary/10 group p-6 shadow-black/5 sm:col-span-2 sm:rounded-none sm:rounded-bl-xl md:p-12">
                        <p className="mx-auto mb-12 max-w-md text-balance text-center text-lg font-semibold sm:text-2xl">Intuitive Experience, Instant Access</p>
                    ...
                    <Card className="bg-primary/10 group relative shadow-black/5 sm:col-span-3 sm:rounded-none sm:rounded-br-xl">
                        <CardHeader className="p-6 md:p-12">
                            <p className="font-bold">HR Made Simple and Powerful</p>
