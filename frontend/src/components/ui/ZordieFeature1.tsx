    ...
    <section className="min-h-screen bg-gray-50 py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8"> 
      <div className="flex flex-col md:flex-row md:items-center md:justify-between max-w-7xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight max-w-4xl mb-6 sm:mb-8 md:mb-12">
          How Our Tool Enhances<br />
          <span className="text-blue-700">Team Productivity</span>
        </h2>
        <span className="text-base md:text-lg text-gray-600 md:max-w-sm md:text-right">
          Boost your team’s efficiency and collaboration effortlessly with our intuitive and powerful platform, designed for success.
        </span>
      </div>
